...
USER_INVALID = shop_user.ShopUser("0000000000", shop_user.UNAUTHORIZED)
...
class TestFsmStateTransitions:
    ...
    def test_closed_invalid_events(self):
        event_q = queue.Queue()
        shop_user_db= shop_user_database.ShopUserDatabaseSpoof()
    ...
    def test_clearing_debt_invalid_swipe(self):
        assert True == False # spoofed database doesn't check for validity
