...
USER_POD = shop_user.ShopUser(["POD Joe", VALID_TEST_DATE, "email", "", "1", 0, shop_user.IS_PROCTOR])
USER_PROCTOR = shop_user.ShopUser(["Proctor Joe", VALID_TEST_DATE, "email", "", "0", 0, shop_user.IS_PROCTOR])
