...
class BoardFsm():
    ...
    def __init__(self, event_q):
        ...
        self.state_data = {
            ...
            OPENING : ("Starting up!\n\rType BUTTON_CANCEL or flip_switch_off.",
                       {event.BUTTON_CANCEL : self.return_to_closed,
            ...
            UNLOCKED : ("Board Unlcked.\n\rAll inputs available.",
                        {event.BUTTON_CANCEL : self.return_to_standby,
    ...
    def return_to_closed(self, ignore_me, ignore_me_too) : return (CLOSED, None)

    def return_to_standby(self, ignore_me, ignore_me_too): return (STANDBY, None)

    def go_to_remove_user_state(self, slot, ignore_me):    return (REMOVING_USER, slot)
    
    def go_to_clear_money_state(self, slot, ignore_me):    return (CLEARING_DEBT, None)

    def go_to_change_pod_state(self, slot, ignore_me):     return (CHANGING_POD, None)
